...
FUNCTION(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname _browsercommand)
    ...
    ADD_CUSTOM_TARGET(${_targetname}
            ...
            COMMAND ${LCOV_PATH} --rc lcov_branch_coverage=1 --remove ${_outputname}.info 'build/*' 'tests/*' '/usr/*' '${CMAKE_CURRENT_SOURCE_DIR}/googletest-lib/*' --output-file ${_outputname}.info.cleaned
